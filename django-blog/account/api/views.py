...
class ProfileView(RetrieveUpdateAPIView):
    ...
    #lookup_field = 'pk' # UpdateAPIView kullandığımız için lookup field kullanıyoruz.

    def get_object(self): #queryseti böyle de çağırabiliriz.
...
class UpdatePassword(APIView):
    ...
    # def get_object(self, queryset=None): # Giriş yapmış kullanıcıyı çevirir. Get_object ile de olur aşağıda user'ı da çağırabiliriz.
    #     return self.request.user

    def put(self, request, *args, **kwargs):
        # self.object = self.get_object() # Giriş yapan kullanıcı çağırdık.
        ...
        if serializer.is_valid():
            ...
            if not self.object.check_password(old_password):
                return Response({"old_password": "Wrong Password with new password"},
